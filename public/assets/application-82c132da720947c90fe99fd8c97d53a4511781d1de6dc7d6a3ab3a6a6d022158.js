(() => {
      ...
      (function() {
        window.rum !== false && (function(window2, document2, location2) {
          ...
          var monitoringMeasures, _toQuery = function(obj) {
            obj._ = (/* @__PURE__ */ new Date()).getTime();
              ...
              window2.XMLHttpRequest = function() {
                ...
                request.addEventListener("readystatechange", function() {
                  ...
                  if (request.readyState == 1) {
                    monitoringStart = +/* @__PURE__ */ new Date();
                  }
                  if (request.readyState == 4) {
                    ...
                    if (logjamRequestId && logjamRequestAction) {
                      var requestData = {
                        ...
                        rts: [monitoringStart, +/* @__PURE__ */ new Date()],
    ...
    "node_modules/jquery/dist/jquery.js"(exports2, module2) {
      (function(global2, factory) {
        ...
        var Sizzle = (
           ...
           */
          (function(window3) {
            var i2, support2, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate, setDocument, document3, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches, matches2, contains, expando = "sizzle" + 1 * /* @__PURE__ */ new Date(), preferredDoc = window3.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
              if (a === b) {
                hasDuplicate = true;
              }
              return 0;
      ...
      jdPicker = (function($) {
        ...
        jdPicker.prototype = {
          ...
          selectMonth: function(date3) {
            ...
            if (this.isNewDateAllowed(newMonth)) {
              if (!this.currentMonth || !(this.currentMonth.getFullYear() == newMonth.getFullYear() && this.currentMonth.getMonth() == newMonth.getMonth())) {
                ...
                $("td[date='" + this.dateToString(/* @__PURE__ */ new Date()) + "']", this.tbody).addClass("today");
          ...
          selectDate: function(date3) {
            ...
            ;
            if (!date3) date3 = /* @__PURE__ */ new Date();
    ...
    "vendor/logjam/app/assets/javascripts/select2.js"() {
      ...
      (function($12, undefined2) {
        ...
        function indexOf(value, array2) {
          ...
          for (; i2 < l; i2 = i2 + 1) {
            if (equal(value, array2[i2])) return i2;
          }
          return -1;
        }
        ...
        function equal(a, b) {
          if (a === b) return true;
          if (a === undefined2 || b === undefined2) return false;
        ...
        function splitVal(string2, separator) {
          var val, i2, l;
          if (string2 === null || string2.length < 1) return [];
          val = string2.split(separator);
          for (i2 = 0, l = val.length; i2 < l; i2 = i2 + 1) val[i2] = val[i2].trim();
          return val;
        }
          ...
          return function(query) {
            ...
            process = function(datum2, collection) {
              ...
              if (datum2.children) {
                group = {};
                for (attr in datum2) {
                  if (datum2.hasOwnProperty(attr)) group[attr] = datum2[attr];
                }
                group.children = [];
        ...
        function defaultTokenizer(input, selection2, selectCallback, opts) {
          ...
          if (!opts.createSearchChoice || !opts.tokenSeparators || opts.tokenSeparators.length < 1) return undefined2;
          while (true) {
            index = -1;
        ...
        AbstractSelect2 = clazz(Object, {
          ...
          init: function(opts) {
            ...
            if (disabled === undefined2) disabled = false;
            this.enable(!disabled);
            var readonly = opts.element.prop("readonly");
            if (readonly === undefined2) readonly = false;
                  ...
                  if (opts.initSelection === undefined2) {
                    opts.initSelection = function(element2, callback) {
                      ...
                      $12(splitVal(element2.val(), opts.separator)).each(function() {
                        ...
                        if (isFunction(tags2)) tags2 = tags2();
          ...
          enable: function(enabled) {
            if (enabled === undefined2) enabled = true;
          ...
          readonly: function(enabled) {
            if (enabled === undefined2) enabled = false;
          ...
          getPlaceholder: function() {
            ...
            this.opts.element.data("placeholder") || this.opts.placeholder || ((placeholderOption = this.getPlaceholderOption()) !== undefined2 ? placeholderOption.text() : undefined2);
          },
          // abstract
            ...
            function resolveContainerWidth() {
              ...
              if (this.opts.width === "off") {
                ...
                if (this.opts.width === "resolve") {
                  ...
                  if (style2.indexOf("%") > 0) return style2;
                  return this.opts.element.outerWidth(false) === 0 ? "auto" : this.opts.element.outerWidth(false) + "px";
                }
                return null;
        ...
        SingleSelect2 = clazz(AbstractSelect2, {
          ...
          isPlaceholderOptionSelected: function() {
            var placeholderOption;
            if (this.getPlaceholder() === undefined2) return false;
          ...
          setPlaceholder: function() {
            ...
            if (this.isPlaceholderOptionSelected() && placeholder !== undefined2) {
              if (this.select && this.getPlaceholderOption() === undefined2) return;
    ...
    "node_modules/d3-dispatch/src/dispatch.js"() {
      ...
      Dispatch.prototype = dispatch.prototype = {
        ...
        on: function(typename, callback) {
          ...
          if (arguments.length < 2) {
            while (++i2 < n) if ((t = (typename = T[i2]).type) && (t = get(_[t], typename.name))) return t;
            return;
          }
  ...
  function numberArray_default(a, b) {
    ...
    return function(t) {
      for (i2 = 0; i2 < n; ++i2) c[i2] = a[i2] * (1 - t) + b[i2] * t;
      return c;
    };
  }
  ...
  function string_default(a, b) {
    ...
    return s.length < 2 ? q[0] ? one(q[0].x) : zero2(b) : (b = q.length, function(t) {
      for (var i3 = 0, o; i3 < b; ++i3) s[(o = q[i3]).i] = o.x(t);
      return s.join("");
    });
  }
  var reA, reB;
  ...
  function styleTween(name, value, priority) {
    ...
    function tween() {
      var i2 = value.apply(this, arguments);
      if (i2 !== i0) t = (i0 = i2) && styleInterpolate(name, i2, priority);
      return t;
    }
    tween._value = value;
    return tween;
  ...
  function chord(directed, transpose) {
    ...
    function chord2(matrix) {
      ...
      for (let i2 = 0; i2 < n; ++i2) {
        let x2 = 0;
        for (let j2 = 0; j2 < n; ++j2) x2 += matrix[i2 * n + j2] + directed * matrix[j2 * n + i2];
        k += groupSums[i2] = x2;
      }
      ...
      dx = k ? padAngle : tau / n;
      {
        ...
        for (const i2 of groupIndex) {
          ...
          if (directed) {
            ...
            if (sortSubgroups) subgroupIndex.sort((a, b) => sortSubgroups(a < 0 ? -matrix[~a * n + i2] : matrix[i2 * n + a], b < 0 ? -matrix[~b * n + i2] : matrix[i2 * n + b]));
            ...
            if (sortSubgroups) subgroupIndex.sort((a, b) => sortSubgroups(matrix[i2 * n + a], matrix[i2 * n + b]));
            for (const j2 of subgroupIndex) {
              let chord3;
              if (i2 < j2) {
                ...
                if (i2 === j2) chord3.source = chord3.target;
              }
  ...
  function ribbon(headRadius) {
    ...
    function ribbon2() {
      ...
      if (!context2) context2 = buffer = path();
      if (ap > epsilon2) {
      ...
      return function(date3) {
        ...
        while (++i2 < n) {
          if (specifier.charCodeAt(i2) === 37) {
            ...
            if (format2 = formats2[c]) c = format2(date3, pad2);
            string2.push(c);
            j2 = i2 + 1;
          }
        }
    ...
    function parseSpecifier(d, specifier, string2, j2) {
      ...
      while (i2 < n) {
        ...
        if (c === 37) {
          ...
          if (!parse || (j2 = parse(d, string2, j2)) < 0) return -1;
  ...
  function arc_default() {
    ...
    function arc() {
      ...
      if (!(r1 > epsilon4)) context2.moveTo(0, 0);
        ...
        if (!(da1 > epsilon4)) context2.moveTo(x01, y01);
        ...
        if (!(r0 > epsilon4) || !(da0 > epsilon4)) context2.lineTo(x10, y10);
  ...
  function logjam_live_stream_chart(params) {
    ...
    function re_scale() {
      ...
      for (var i2 = 0; i2 < num_slots; ++i2) {
        var sum_slot = 0;
        for (var j2 = 0; j2 < num_areas; ++j2) sum_slot += data[j2][i2];
    ...
    function update_errors(errors) {
      ...
      for (var i2 = 0, len = errors.length; i2 < len; ++i2) {
        ...
        var onclick = /* @__PURE__ */ (function(u) {
          return function() {
    ...
    function update_view(value) {
      if (Array.isArray(value)) {
        ...
        update_chart(value);
        (0, import_jquery8.default)("#livestream-updated-at").html((/* @__PURE__ */ new Date()).toLocaleTimeString());
      }
    }
    ;
    var ws = null;
  ...
  function logjam_graph_app_data(appCallers) {
    ...
    appCallers.forEach((d) => {
      ...
      if (!row) {
        row = matrix[source] = [];
        for (var i3 = -1; ++i3 < n; ) row[i3] = 0;
      }
      row[index] = d.count;
      if (!scaled_row) {
        scaled_row = scaled_matrix[source] = [];
        for (var j3 = -1; ++j3 < n; ) scaled_row[j3] = 0;
      }
...
urijs/src/URI.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application.js-90b9084d3da16ea11909555a8369bea6b936a4b185c713403866a8753faa4971.map
//!
;
